  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Prompt Engineering Guides</h1>
        <p className="mt-3 text-lg text-gray-600">{guides.length} comprehensive guides to help you write better prompts and get better results from AI.</p>
      </div>
